...
function multiplyNums(uno, dos, cb) {
  cb(uno * dos);
}
...
function removeDuplicates(array, cb) {
  var uniqueFoods = array.filter(function (elem, pos) {
  cb(array.indexOf(elem) == pos);
});
}
